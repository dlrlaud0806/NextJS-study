  ...
  return (
    <div className="max-w-full max-h-full mx-auto">
      ...
      <div className="flex place-content-center space-x-3">
        <h1 className="p-4 text-lg text-center font-medium">{ltCur.drwNo}</h1>
      ...
      {sorted_hist.map((lt, idx) => (
        <div key={idx} className="flex place-content-center space-x-3">
          <h1 className="p-4 text-lg text-center font-medium">{lt[1].drwNo}</h1>
          <img
